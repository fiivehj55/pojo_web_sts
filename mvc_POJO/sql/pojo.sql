...
select SEQ_HOUSE_AVAIL_DATE.currval from dual;
  ...
  CREATE TABLE "POJO"."REGIST_HOUSE" 
   (	"RH_ID" NUMBER(20,0) NOT NULL ENABLE, 
	"CHECK_IN" VARCHAR2(30 BYTE), 
	"CHECK_OUT" VARCHAR2(30 BYTE), 
  ...
  CREATE TABLE "POJO"."QUESTION_TO_REPLY" 
   (	"QUEST_REPLY_NO" NUMBER(30,0) NOT NULL ENABLE, 
	...
	"QUEST_REPLY_DATE" VARCHAR2(30 BYTE), 
