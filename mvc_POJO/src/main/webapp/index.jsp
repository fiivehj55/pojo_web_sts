...
<link href='https://fonts.googleapis.com/css?family=Montserrat'
	rel='stylesheet' type='text/css'>
<link
	href="<%=request.getContextPath()%>/videoback/css/fullscreenDemo.css"
	rel="stylesheet" type="text/css">
<script
...
<!-- 					<li><a href="bbs?page=1">문의게시판</a>
	...
	<div id="featured">
		<div class="container">
			...
			<p>
				저희 <strong>사랑방손님은</strong>,온라인 및 모바일에서 두정동 근처의 독특한 숙소들을 올리고, 발견하고, <a
					href="http://templated.co">예약할 수 있는</a>믿을만한 커뮤니티 플랫폼 입니다.
				<!--    <a href="http://templated.co/license">사랑방손님은 간편합니다.</a> -->
				하룻밤 지낼 원룸, 일주일 동안 지낼 수 있는 오피스텔, 한달 동안 지낼 수 있는 빌라 등 &ndash; 다양한 가격대의
				숙소가 여러분을 기다리고 있습니다! 사랑방 손님은 남는 공간을 통해 <a href="http://templated.co">수익을
					창출하고 </a> 여러사람들에게 보여줄 수 있는 가장 <a href="http://twitter.com/templatedco">쉬운
					방법입니다.</a><br />
			</p>
			<hr />

			<div class="d3">
				<form method="get" action="searchbar" name="form1"
					onsubmit="return false;">
					<input id="text_box" name="key" type="text"
						placeholder="두정동 또는 건물이름을 입력하세요"
						onkeydown="if(event.keyCode == 13) submitCheck();"> <input
	...
	<div class="container">
		...
		<div class="wrap">
			<div class="tile">
				<a href="#"> <img
					src='http://www.blueb.co.kr/SRC2/_image/s_01.jpg' />
					<div class="text">
						<h1>Lorem ipsum.</h1>
						<h2 class="animate-text">More lorem ipsum bacon ipsum.</h2>
						<p class="animate-text">Bacon ipsum dolor amet pork belly
		...
		<div class="tile">
			<img src='http://www.blueb.co.kr/SRC2/_image/s_02.jpg' /> <a
				href="#">
				<div class="text">
					<h1>Lorem ipsum.</h1>
					<h2 class="animate-text">More lorem ipsum bacon ipsum.</h2>
		...
		<div class="tile">
			<a href="#"> <img
				src='http://www.blueb.co.kr/SRC2/_image/s_03.jpg' />
				<div class="text">
					<h1>Lorem ipsum.</h1>
					<h2 class="animate-text">More lorem ipsum bacon ipsum.</h2>
					<p class="animate-text">Bacon ipsum dolor amet pork belly
