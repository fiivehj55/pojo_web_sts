...
<body>
			...
			-->
				...
				<div id="tx_canvas" class="tx-canvas">
					<div id="tx_loading" class="tx-loading">
						<div>
							<img src="<%=request.getContextPath()%>/daumeditor/images/icon/editor/loading2.png" width="113"
				...
				<div id="tx_resizer" class="tx-resize-bar">
					...
					<img id="tx_resize_holder"
						src="<%=request.getContextPath()%>/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58"
	...
	<p>
		...
		<img src="snapshot/images/icon/p_gif_s.gif" /> editor_bi.gif</a>
	</p> -->
	</textarea>
	<script type="text/javascript">
