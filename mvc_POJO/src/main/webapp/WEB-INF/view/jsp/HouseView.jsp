...
<!-- <div id='container'> -->
    ...
    <div id='right-box'>
 			 <c:if test="${user!=null}"> 
				<a href="#" class="button button-style1">예약하기</a><p>
				<c:if test="${user. memId == houseUser}">
				
				<p><a href="updateHouse?houseNo=${houseNo}"  class="button button-style1">
				수정하기</a>
				
				<p><a href="deleteHouse?houseNo=${houseNo}" class="button button-style1">
				삭제하기</a>
...
<div class="divTableCell" style="width: 300px; height: 250px;">
			<h3 class="h3">상세설명</h3>
			 <p> ${houseInfo }
<p><h5 class="h5"><img src="css/images/icon1.png" width="50" height="50"/>방의 개수:  ${houseRoom }
...
&nbsp&nbsp<img src="css/images/icon4.JPG" width="50" height="50"/>사용가능한 편의시설:  ${houseAircon }, ${houseWifi },${houseElebe }, ${houseWashing }
</h5>
