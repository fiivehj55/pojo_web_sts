...
<body class="">
	<h1 align="center">사랑방 손님</h1>
	<table style="margin-left:430px;">
		<caption>POJO 이용약관</caption>
		<colgroup>
			<col width="90%" />
			<col width="10%" />
		</colgroup>
		<thead>
			<tr>
				<th align="left">이용약관, 개인정보 수집 및 이용,<br /> 위치정보 이용약관(선택), 프로모션
					안내<br /> 메일 수신(선택)에 모두 동의합니다.
				</th>
...
이메일 주소 : fivehj55@naver.com
			...
			<tr>
				<td align="center" colspan="2">
					<a href="join"><input type="button" value="등록"/></a>
