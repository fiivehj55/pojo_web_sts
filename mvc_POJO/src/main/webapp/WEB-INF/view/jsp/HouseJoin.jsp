			...
			<form method="post" action="insertHouse" name="form" id="myForm"
					...
					<div id="one" style="display: block;">
						<fieldset>
							...
							<span
								...
								value="1명" id="hone" checked="checked"> 
				...
				<div id="container1">
					<div id="two" style="display: none;">
						<fieldset>
							...
							<p>
								<label>숙소이름</label> <input type="text" id="rname" name="rname" size="50" />
							</p>
							...
							<a href="#" class="button button-style-1" id="postcodify_search_button">주소검색</a><br /> 
								...
								<label>사진 최대 10장 가능합니다.</label>
							
								<input type="file" name="photo" multiple="multiple" /> <br /> 
								<label>숙소 안내말</label>
								
								<textarea name="infor" id="ir1" rows="10" cols="100" style="width:70%; height: 412px; display: none;" placeholder="에디터에 기본으로 삽입할 글(수정 모드)이 없다면 이 value 값을 지정하지 않으시면 됩니다."></textarea> <br />
				...
				<div id="container1">
					<div id="four" style="display: none;">
						...
						<input type="submit" class="button2" id="next" name="next" value="하우스등록" style="padding: 10px;" onclick="submitContents(this)"/>
					</div>
				</div>
			</form>
		</div>
